...
async function trainnlp() {
    ...
    if (fs.existsSync('./model.nlp')) {
        ...
        let res = await nlp.process('thông báo cho tôi về thời tiết mỗi ngày')
        res.entities = res.entities.concat(interval_ner.process('thông báo cho tôi về thời tiết mỗi ngày'))
        console.dir(res, {depth: null})
